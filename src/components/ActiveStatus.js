    ...
    <div>
      ...
      >
        <div in={open}>
          ...
          <Typography
            style={{ position: "relative", height: "447px" }}
            className={classes.paper}
          >
            <img src={coverage} className={classes.img} alt="coverage-img" />
            ...
            <img
              src={active}
              style={{ position: "absolute", left: "40px", marginTop: "5px" }}
              alt="dot-img"
            />

            <div style={{ position: "absolute", left: "60px" }}>Active</div>
            ...
            <div
              style={{ position: "absolute", left: "50px", marginTop: "65px" }}
            >
              23546675
            </div>
            ...
            <br />
            <div
              style={{ position: "absolute", left: "50px", marginTop: "145px" }}
            >
              John Doe
            </div>
